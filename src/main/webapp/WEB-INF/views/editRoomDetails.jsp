...
<nav class="navbar navbar-default navbar-inverse" role="navigation" style="background-color: rgb(255,255,255);height:105px; border-color: white;">
 ...
 <div class="main-content">
  <form class="form-basic" method="post" action="saveEditedRoom" onSubmit="return RoomSubmit()" enctype="multipart/form-data" style="background-color: rgb(245,126,182);">
...
<!--                 <a><button class="button btn-info" type="submit" value="Submit" >Submit</button></a> -->
                
               <center> <button type="submit" name="submit" value="Submit" id="submit">Submit</button> </center>
            </div>		   
