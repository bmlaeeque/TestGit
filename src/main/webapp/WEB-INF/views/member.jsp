...
<%--      <h5>${sessionScope.member.mId}</h5> --%>
       <li><a href="logoutMember"><b><font color=#000000">Logout</font></b></a></li>
       <li><a href="editMemberProfile/${member.mId}"><b><font color=#000000">Edit Your Profile</font></b></a></li>
<!--        <li><a href="memberHouse"><b><font color=#000000">Your Searched Homes</font></b></a></li>  -->
       <li><a href="memberList"><b><font color=#000000">Member List</font></b></a></li> 

         <li><h5><b><i>${sessionScope.member.mId}</i></b></h5></li>
...
<!--        <li><a href="showHouseReg"><b><font color=#000000">House Registration</font></b></a></li> -->
    ...
    <c:otherwise> 
      <li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown"><b><font color="#000000">Member Login</font></b>
						...
						<li>
							<div class="row">
								...
								<div class="bottom text-center">
									New here ? <a href="showMemberReg"><b><font
...
<div class="container-fluid">
  ...
  <img src="images/2.jpg" style="width: 100%; height:1000px;">         
 <div class="heading">
