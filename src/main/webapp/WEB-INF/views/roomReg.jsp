    ...
    <div class="form-row" style="float:left;">
      ...
      <tbody style="background-color: rgb(243,210,230);">
          <tr>
           ...
           <td><input type="radio" name="ac" value="No"><span>No</span></td>
          </tr>
         <tr>
           <td>Wifi</td>
           <td><input type="radio" name="wifi" value="Yes" ><span>Yes</span></td>
           <td><input type="radio" name="wifi" value="No"><span>No</span></td>
          </tr>
         <tr>
           <td>Bathroom</td>
           <td><input type="radio" name="bathroom" value="Yes"><span>Yes</span></td>
           <td><input type="radio" name="bathroom" value="No"><span>No</span></td>
        </tr>
         <tr>
           <td>Geyser</td>
           <td><input type="radio" name="geyser" value="Yes">><span>Yes</span></td>
           <td><input type="radio" name="geyser" value="No" ><span>No</span></td>
         </tr>
         <tr>
           <td>Bed</td>
           <td><input type="radio" name="bed" value="Yes">><span>Yes</span></td>
           <td><input type="radio" name="bed" value="No"><span>No</span></td>
         </tr>
         <tr>
           <td>Swimming Pool&nbsp;&nbsp;&nbsp;&nbsp;</td>
           <td><input type="radio" name="swimmingPool" value="Yes"> ><span>Yes</span></td>
           <td><input type="radio" name="swimmingPool" value="No"><span>No</span></td>
         </tr>
          <tr>
           <td>Parking</td>
           <td><input type="radio" name="parking"  value="Yes">><span>Yes</span></td>
           <td><input type="radio" name="parking" value="No"><span>No</span></td>
         </tr>
          <tr>
           <td>Gym</td>
           <td><input type="radio" name="gym"  value="Yes">><span>Yes</span></td>
           <td><input type="radio" name="gym" value="No"><span>No</span></td>
          </tr>
     </tbody>
</table>
   </div>
