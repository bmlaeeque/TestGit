...
<!--     Collect the nav links, forms, and other content for toggling -->
 ...
 <%-- <nav class="navbar navbar-default navbar-inverse" role="navigation"
  ...
  <form class="form-basic" method="post" action="saveEditedMember" onSubmit="return Submit()" style="background-color: rgb(245,126,182);">
	 ...
	 <div class="form-title-row">
		...
		<div class="form-row" style="float:left; width:50%;">
          ...
          <input type="text" name="firstName" id="firstName" placeholder="First Name" onBlur="CheckName(); return false;" autocomplete="off" value="${member.firstName}">
             </label>
             <label>
                    <span>Contact No.</span>
                    <input type="text" name="contactNumber" id="contact" placeholder="Contact Number" onBlur="checkContactNumber();CheckPhoneNumber(); return false;" autocomplete="off" value="${member.contactNumber}">
             </label>
             <label>
                    <span>Password</span>
                    <input type="password" name="password1" id="password1" placeholder="Password" onBlur="CheckPassword(); return false;" autocomplete="off" value="${member.password}">
             </label>
             <label>
                    <span>Aadhar Number</span>
                    <input type="text" name="aadharNumber" id="aadharNumber" placeholder="Aadhar Number" onBlur="checkAadharNumber();CheckAadhar(); return false;" autocomplete="off" value="${member.aadharNumber}">
             </label> 
            </div>
        <div class="form-row" style="float:left; width:50%;">
                <label>
                    <span>Last name</span>
                    <input type="text" name="lastName" id="lastName" placeholder="Last Name" onBlur="CheckLastName(); return false;" autocomplete="off" value="${member.lastName}">
                </label>
                <label>
                    <span>Email</span>
                    <input type="text" name="email" id="email" placeholder="Email" onBlur="checEmail();CheckEmail(); return false;" autocomplete="off" value="${member.email}">
                </label>
                <label>
                ...
                <input type="hidden" name="oId" id="oId" value="${member.mId}">
              </div>
